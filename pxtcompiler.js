        ...
        function compileBinary(program, host, opts, res, entryPoint) {
            ...
            */
            ...
            function emitFuncCore(node) {
                ...
                if (node.parent.kind == pxtc.SK.ClassDeclaration) {
                    ...
                    if (node.kind == pxtc.SK.Constructor) {
                        if (classInfo.ctor)
                            ...
                            classInfo.ctor = proc;
                        for (var _i = 0, _a = classInfo.allfields; _i < _a.length; _i++) {
                            var f = _a[_i];
                ...
                for (var _b = 0, fieldAssignmentParameters_1 = fieldAssignmentParameters; _b < fieldAssignmentParameters_1.length; _b++) {
                    var p = fieldAssignmentParameters_1[_b];
                ...
                for (var _c = 0, initalizedFields_1 = initalizedFields; _c < initalizedFields_1.length; _c++) {
                    var f = initalizedFields_1[_c];
